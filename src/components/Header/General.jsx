  ...
  return (
    <header className="text-primary-white body-font bg-primary-gray">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <Link
          href="/signin"
          className="inline-flex items-center bg-primary-black text-primary-gray font-medium border-0 py-1 px-3 focus:outline-none hover:bg-opacity-80 rounded text-base mt-4 md:mt-0 "
        >
          Sign in
        </Link>
      </div>
